...
const LayoutAdmin = () => {
  ...
  return (
    <div className='flex gap-4 bg-[#0b0b0b] h-screen'>
        <section className={`flex w-64 bg-[#171717] transition-all duration-300 ease-in-out ${hideSiderBar ? 'mx-4 w-[56px] overflow-hidden' : ''}`}>
            <SiderBarAdmin  hideSiderBar={hideSiderBar}/>
        </section>
        <section className={`flex w-5/6 p-4  `}>
