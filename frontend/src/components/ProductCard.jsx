...
const ProductCard = (item) => {
    ...
    return (
    <div className='rounded-lg flex flex-col gap-2 p-2 shadow-lg hover:shadow-2xl cursor-pointer hover:translate-y-[-5px] transition-all duration-300'>
        <img src={item.item.image} alt="product image" className=''/>
        ...
        <div className='flex'>
            <div className='flex flex-col w-1/3 gap-2'>
                <span >Size</span>
                <select name="size" className='w-1/2 outline-1 outline-gray-500 rounded-md'>
                    {
        ...
        <div className='flex py-2 justify-between'>
            ...
            <div className="flex gap-2 mr-4 border border-gray-400 shadow-md rounded-md px-4 items-center ">
